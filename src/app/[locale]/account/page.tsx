...
export default function AccountPage() {
  ...
  async function handleDelete() {
    ...
    try {
      ...
      setError('Something went wrong. Please try again or contact privacy@goodgameparent.com.')
      setDeleting(false)
    }
  }
      ...
      <main className="max-w-lg mx-auto px-4 py-10 space-y-6">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl border border-red-200 dark:border-red-900 shadow-sm px-5 py-4 space-y-3">
          ...
          <p className="text-sm text-slate-600 dark:text-slate-400">
            Deleting your account permanently removes all your data — child profiles, game lists, and
            community tips. This cannot be undone.
          </p>
          ...
          {!confirming ? (
            ...
            <div className="space-y-2">
              <p className="text-sm font-semibold text-slate-800 dark:text-slate-200">Are you sure? This is permanent.</p>
